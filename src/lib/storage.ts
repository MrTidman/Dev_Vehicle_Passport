...
// Allowed MIME types for vehicle documents (images and PDFs)
...
/**
 * Validate file type - only allows images and PDFs
 ...
 * @throws Error if file type is not allowed or file size exceeds limit
 */
